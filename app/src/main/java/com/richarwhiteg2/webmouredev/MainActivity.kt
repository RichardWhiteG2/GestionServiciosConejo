package com.richarwhiteg2.webmouredev
...
/* Realizada por Ing. Brayan Ricardo Blanco García
    ...
    Se establecio un tiempo de 6 minutos en que se está actualizando para que siempre muestre la pantalla de generar tickets.
...
class MainActivity : AppCompatActivity() {
    ...
    fun temporizador(){
        val recargar = Intent(this, MainActivity::class.java) //para recargar activity
